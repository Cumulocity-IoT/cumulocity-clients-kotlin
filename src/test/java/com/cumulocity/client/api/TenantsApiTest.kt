...
class TenantsApiTest {
    ...
    fun testFactoryCreatesObject() {
        val api = TenantsApi.Factory.create("your tenant")
    ...
    fun testGetTenants() {
    	...
    	api.getTenants().enqueue(object : Callback<TenantCollection> {
    		...
    		override fun onFailure(call: Call<TenantCollection>?, t: Throwable?) {
    			println(t)
    			latch.countDown()
    		}
    	})
    ...
    fun testGetCurrentTenant() {
    	...
    	api.getCurrentTenant().enqueue(object : Callback<CurrentTenant> {
    		...
    		override fun onFailure(call: Call<CurrentTenant>?, t: Throwable?) {
    			println(t)
    			latch.countDown()
    		}
    	})
