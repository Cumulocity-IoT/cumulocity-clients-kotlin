...
class ManagedObject {
	 ...
	 */
	@SerializedName(value = "c8y_LatestMeasurements")
	var c8yLatestMeasurements: C8yLatestMeasurements? = null
	...
	class JsonAdapter: JsonDeserializer<ManagedObject>, JsonSerializer<ManagedObject> {
		...
		override fun serialize(src: ManagedObject?, typeOfSrc: java.lang.reflect.Type?, context: JsonSerializationContext?): JsonElement {
			...
			src?.c8yLatestMeasurements?.let { it -> jsonTree.add("c8y_LatestMeasurements", context?.serialize(it)) }
