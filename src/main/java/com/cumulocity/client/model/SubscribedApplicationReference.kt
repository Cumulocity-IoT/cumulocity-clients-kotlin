...
data class SubscribedApplicationReference(var application: Application?) {
	constructor() : this(application = null)

	/**
	 * The application to be subscribed to.
	 */
	data class Application(var self: String?) {
		constructor() : this(self = null)
